...
<!-- SPECIFIC CSS -->
<link href="{{ BASE_URL }}/css/product_page.css" rel="stylesheet">
<main>
    <div class="container margin_30">
        
    @if($product['indirim'] > 0)
    <div class="countdown_inner">- {{ $product['indirim'] }}% Discount <div data-countdown="2024/11/15" class="countdown"></div>
    </div>
    @endif
            ...
            <div class="col-md-6">
                <div class="breadcrumbs">
                    <ul>
                        ...
                        <li><a
                                href="{{ BASE_URL }}kategori/{{ $product['kategori'] }}">{{ $product['kategori'] }}</a>
                        </li>
                        <li>{{ $product['urun_adi'] }}</li>
                    </ul>
                </div>
                <!-- /page_header -->
                <div class="prod_info">
                    ...
                    <span class="rating"><i class="icon-star voted"></i><i class="icon-star voted"></i><i
                            ...
                            reviews</em></span>
                    <p><small>SKU: MTKRY-001</small><br> {{ $product['aciklama'] }}</p>
                    ...
                    <div class="row">
                        <div class="col-lg-5 col-md-6">
                            ...
                            @if($product['indirim'] > 0)
                            <div class="price_main discount"><span class="new_price">{{ $product['indirimli_fiyat'] }} TL
                                </span><span
                                class="percentage">-{{$product['indirim']}}% </span><span class="old_price"> {{ $product['tutar'] }} TL</span></div>

                            @else 
                            <div class="price_main discount"><span class="new_price">{{ $product['tutar'] }} TL
                                </span></div>
                            @endif
                        </div>
                        <div class="col-lg-4 col-md-6">
                            <button class="AddtoCard btn_1 full-width cart" data-id="{{ $product['id'] }}"
                                data-name="{{ $product['urun_adi'] }}" data-price="{{ $product['tutar'] }}"
                                data-image="{{ BASE_URL }}img/products/shoes/1.jpg" data-quantity="1" ><p id="cart-text">Add to Cart</p></button>
            ...
            <div class="item">
                <div class="grid_item">
                    ...
                    <ul>
                        ...
                        <li><a href="#0" class="tooltip-1" data-toggle="tooltip" data-placement="left"
                                title="Add to cart"><i class="ti-shopping-cart"></i><span>Add to cart ASD</span></a></li>
                    </ul>
                </div>
                <!-- /grid_item -->
            </div>
                    ...
                    <ul>
                        ...
                        <li>
                            <form method="POST" >
                                ...
                                <input type="hidden" name="name" value="Air Zoom Alpha">
                                <input type="hidden" name="price" value="140.00">
                                <input type="hidden" name="image" value="img/products/shoes/5.jpg">
                                <input type="hidden" name="quantity" value="1">
                                <button type="submit" class="tooltip-1" data-toggle="tooltip" data-placement="left"
                                    title="Add to cart"><i class="ti-shopping-cart"></i><span>Add to cart ADSA</span></button>
                            </form>
                        </li>
                    </ul>
                </div>
            ...
            <div class="item">
                <div class="grid_item">
                    ...
                    <ul>
                        ...
                        <li><a href="#0" class="tooltip-1" data-toggle="tooltip" data-placement="left"
                                title="Add to cart"><i class="ti-shopping-cart"></i><span>Add to cart ASDAD</span></a></li>
                    </ul>
                </div>
                <!-- /grid_item -->
            </div>
            ...
            <div class="item">
                <div class="grid_item">
                    ...
                    <ul>
                        ...
                        <li><a href="#0" class="tooltip-1" data-toggle="tooltip" data-placement="left"
                                title="Add to cart"><i class="ti-shopping-cart"></i><span>Add to cart ASDA</span></a></li>
                    </ul>
                </div>
                <!-- /grid_item -->
            </div>
            ...
            <div class="item">
                <div class="grid_item">
                    ...
                    <ul>
                        ...
                        <li><a href="#0" class="tooltip-1" data-toggle="tooltip" data-placement="left"
                                title="Add to cart"><i class="ti-shopping-cart"></i><span>Add to cartASDA</span></a></li>
                    </ul>
                </div>
                <!-- /grid_item -->
            </div>
